...
SLOTS = {
    "slot_1": (
        "8月24日（月）15:00〜16:00（スタバ ステージ店）★折り紙でお花づくり"
    ),
    "slot_2": (
        "8月24日（月）16:00〜17:00（スタバ ステージ店）★折り紙でお花づくり"
    ),
    "slot_3": (
        "8月24日（月）18:00〜19:00（スタバ ステージ店）★折り紙でランタンづくり"
    ),
    "slot_4": "8月25日（火）15:00〜16:00（スタバ FKD店）★折り紙でお花づくり",
    "slot_5": "8月25日（火）16:00〜17:00（スタバ FKD店）★折り紙でお花づくり",
    "slot_6": "8月25日（火）18:00〜19:00（スタバ FKD店）★折り紙でお花づくり",
}
