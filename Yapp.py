...
""")
  ...
  with st.form("booking_form"):
    ...
    # 注意事項 & キャンセル方法（メール記載リンク）の説明
    st.markdown("""
📌 **ご予約のキャンセル・注意事項**
* **キャンセル方法:** 万が一ご都合が悪くなった場合は、予約完了時にお送りする**「確認メール」に記載のキャンセル用リンク**よりお手続きいただけます。
* **写真・動画撮影:** 当日はイベントの様子を撮影し、SNS等に掲載させていただく場合がございます。
""")

    agree = st.checkbox(
        "【同意確認】キャンセル方法および当日の撮影・SNS掲載について確認し、同意の上で予約します。*"
    )
